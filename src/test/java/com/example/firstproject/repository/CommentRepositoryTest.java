...
class CommentRepositoryTest {
    ...
    void findByArticleId() {
        /* 4번 게시글의 모든 댓글 조회 */
        {
            ...
            // 검증
            assertEquals(expected.toString(), comments.toString(), "4번 댓글의 모든 댓글을 출력!");
        }
        /* 1번 게시글의 모든 댓글 조회 */
        {
            //입력 데이터 준비
            ...
            // 검증
            assertEquals(expected.toString(), comments.toString(), "1번 댓글의 모든 댓글을 출력");//둘다 빈 문자열(1번 글에 댓글 없음)
        }
    }
    @Test
